...
static const struct regval thcv241_reset_init_table0[] = {
	{0x34, 0xFE, 0x21, 0x00},
	{0x34, 0x06, 0x00, 0x00},
	{0x34, 0x05, 0x00, 0x00},
	{0x34, 0x21, 0x00, 0x00},
...
static int thcv244_thcv241_init(struct thcv244 *thcv244)
{
	...
	ret |= thine_write_reg(thcv244->client, THCV241_ADDR, 0x3e,
					1, THCV244_REG_VALUE_08BIT, 0x0c);
	usleep_range(1000, 2000);
	ret |= thine_write_reg(thcv244->client, THCV241_ADDR, 0x3e,
					1, THCV244_REG_VALUE_08BIT, 0x3c);
	usleep_range(1000, 2000);
...
static int thcv244_thcv241_reset_initial(struct thcv244 *thcv244)
{
	...
	ret |= thcv241_write_array(thcv244->client, thcv241_reset_init_table0);
	ret |= thine_write_reg(thcv244->client, THCV244_ADDR, 0x0032,
